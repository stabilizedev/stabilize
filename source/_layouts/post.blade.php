...
<div class="py-6 sm:pt-12">
    <div
        class="prose lg:prose-xl xl:prose-2xl prose-invert prose-emerald mx-auto px-6 lg:px-0 prose-li:marker:text-emerald-500 prose-blockquote:border-emerald-500 prose-p:before:content-none">
        <div class="mb-8">
            <a href="/blog"
