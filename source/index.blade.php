...
<div class="py-20 sm:py-24 lg:py-32" id="services">
    <div class="mx-auto max-w-screen-2xl px-6 lg:px-12 xl:px-24">
        <div
            class="mx-auto grid max-w-screen-2xl grid-cols-1 gap-x-8 gap-y-20 lg:grid-cols-3">
            <div class="mx-auto max-w-2xl lg:mx-0">
                ...
                <p class="mt-6 text-base leading-7 text-neutral-300">Lorem ipsum
                    ...
                    distinctio illum optio sequi cumque quisquam itaque
                    molestiae
                    fuga, reiciendis possimus porro officiis voluptas
                    temporibus,
                    doloremque accusamus aliquid, eum dolores placeat.</p>
            </div>
            <ul role="list"
                class="mx-auto grid max-w-2xl grid-cols-2 gap-x-6 gap-y-20 lg:mx-0 lg:max-w-none lg:gap-x-8 lg:col-span-2 lg:grid-cols-3">
                <li>
